...
INSERT INTO {association_table} (
	...
	JOIN {temp_schema_path}.basket_primary_count s1 ON 1 = 1
	...
	JOIN {temp_schema_path}.basket_secondary_count s2 ON 1 = 1
	...
	JOIN {temp_schema_path}.basket_total_transactions t ON 1 = 1
